namespace Projekt.Forms
{
    partial class ChickenForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button1.Text = "3 Hot Wings";
			this.button1.UseVisualStyleBackColor = false;
			this.button1.Click += new System.EventHandler(this.ChickenButton_Click);
			// 
			// button2
			// 
			...
			this.button2.Tag = "301";
			this.button2.Text = "5 Hot Wings";
			this.button2.UseVisualStyleBackColor = false;
			this.button2.Click += new System.EventHandler(this.ChickenButton_Click);
			// 
			// button3
			// 
			...
			this.button3.Tag = "302";
			this.button3.Text = "8 Hot Wings";
			this.button3.UseVisualStyleBackColor = false;
			this.button3.Click += new System.EventHandler(this.ChickenButton_Click);
			// 
			// button4
			// 
			...
			this.button8.Location = new System.Drawing.Point(229, 100);
			...
			this.button9.Location = new System.Drawing.Point(337, 100);
			...
			this.button10.Location = new System.Drawing.Point(445, 100);
			this.button10.Name = "button10";
			this.button10.Size = new System.Drawing.Size(102, 81);
			this.button10.TabIndex = 0;
			this.button10.Tag = "309";
			this.button10.Text = "Bites Grande";
			this.button10.UseVisualStyleBackColor = false;
			this.button10.Click += new System.EventHandler(this.ChickenButton_Click);
			// 
			// exitButton
			// 
			...
			this.exitButton.Location = new System.Drawing.Point(229, 187);
